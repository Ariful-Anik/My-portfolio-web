...
const AboutMe = () => {
    return (
        <div className="bg-gradient-to-br flex-col md:flex-row md:w-11/12 mx-auto md:my-16 from-black to-gray-900 text-white py-12 px-8 rounded-lg shadow-lg flex justify-center items-center">
            
            <div className="md:w-4/12 mb-5 md:mb-0">
                <div className="">
                    <img className="h-[500px] md:h-[600px]" src={about_img} alt="" />
                </div>
            </div>
            {/* Content Wrapper */}
            <div className="bg-gray-800 p-8 rounded-md shadow-md w-full md:w-8/12 max-w-4xl">
